...
var App = function() {
  ...
  function _() {
      ...
      function u(t) {
          ...
          $.each(e, function(t, e) {
              var i = $(this).find("> a span").html()
                , r = $(this).find("> ul")
                , n = $("> li", r)
                , o = (i = $('<li class="title">' + i + "</li>"),
              $('<li class="nav-items"><div class="am-scroller"><div class="content"><ul></ul></div></div></li>'));
              !r.find("> li.title").length > 0 && (r.prepend(i),
              n.appendTo(o.find(".content ul")),
              o.appendTo(r))
          })
      }
      function f() {
          t.removeClass(S.openLeftSidebarClass).addClass(S.transitionClass),
          L()
      }
      function g() {
      ...
      function m(t, e, i) {
          var r = $(t).parent()
            ...
            , s = "touchstart" == e.type;
          $.isXs() || (d && !s || g(),
          (!i || i && !a) && (d && !i ? l = setTimeout(function() {
              r.is(":hover") && (g(),
              r.addClass("open"),
              n.addClass("visible"))
          }, S.leftSidebarOpenSubMenuDelay) : (r.addClass("open"),
          n.addClass("visible"))),
          n.removeClass("hide")),
          void 0 !== p && T(p),
          void 0 !== p && p && p.nodeName || (p = M(o)),
          i && r.hasClass("parent") ? e.preventDefault() : S.syncSubMenuOnHover && u(r)
      }
      (u(),
      $(".am-toggle-left-sidebar").on("click", function(e) {
          s && t.hasClass(S.openLeftSidebarClass) ? f() : s || (t.addClass(S.openLeftSidebarClass + " " + S.transitionClass),
          s = !0),
          e.stopPropagation(),
          e.preventDefault()
      }),
      ...
      i.on("mouseleave", function() {
          var t = $(this).parent()
            , e = t.find("> ul");
          clearTimeout(l),
          $.isXs() || (e.length > 0 ? o = setTimeout(function() {
              e.is(":hover") || g()
      ...
      n.on({
          ...
          mouseleave: function() {
              ...
              a = setTimeout(function() {
                  e.is(":hover") || (t.removeClass("visible"),
                  e.removeClass("open"))
      ...
      $(".sidebar-elements li a", r).on("click", function(t) {
          if ($.isXs()) {
              var e, i = $(this), r = S.leftSidebarSlideSpeed, n = i.parent(), o = i.next();
              ...
              i.next().is("ul") && t.preventDefault(),
              void 0 !== p && T(p)
          }
      }),
      $("li.active", r).parents(".parent").addClass("active"),
      e.hasClass("am-fixed-sidebar")) && ($(".am-left-sidebar > .content").wrap('<div class="am-scroller-fixed-left-sidebar"></div>'),
      h = M($(".am-scroller-fixed-left-sidebar")),
  ...
  function E() {
      ...
      function a() {
          t.removeClass(S.openRightSidebarClass).addClass(S.transitionClass),
          L()
      }
      n.length > 0 && ($(".am-toggle-right-sidebar").on("click", function(e) {
          s && t.hasClass(S.openRightSidebarClass) ? a() : s || (t.addClass(S.openRightSidebarClass + " " + S.transitionClass),
          s = !0),
          e.stopPropagation(),
          e.preventDefault()
      }),
      ...
      void 0 !== m && m && m.nodeName || (m = M(e)),
      void 0 !== b && b && b.nodeName || (b = M(i)),
      void 0 !== v && v && v.nodeName || (v = M(r)),
      void 0 !== y && y && y.nodeName || (y = M(o)),
      $(window).resize(function() {
          P(function() {
              x(m),
              x(b),
  ...
  return {
      ...
      init: function(o) {
          ...
          S.enableSwipe && function() {
              var r = !1;
              function o() {
                  s || e.hasClass(S.removeLeftSidebarClass) || (t.addClass(S.openLeftSidebarClass + " " + S.transitionClass),
                  s = !0)
              }
              function a() {
                  !s && n.length > 0 && (t.addClass(S.openRightSidebarClass + " " + S.transitionClass),
                  s = !0)
              }
              i.swipe({
          ...
          S.scrollTop && ((a = $('<div class="am-scroll-top"></div>')).appendTo("body"),
          ...
          A.primary = Y("clr-primary"),
          A.success = Y("clr-success"),
          A.info = Y("clr-info"),
          A.warning = Y("clr-warning"),
          A.danger = Y("clr-danger"),
          A.alt1 = Y("clr-alt1"),
          A.alt2 = Y("clr-alt2"),
          A.alt3 = Y("clr-alt3"),
          A.alt4 = Y("clr-alt4"),
          ...
          d.length && (f = M($(".am-scroller-top-messages")),
          g = M($(".am-scroller-notifications"))),
          u.length && (l = u,
          $.isSm() || (k = M(u)),
          $(window).resize(function() {
          ...
          C.am_scroller = p,
          C.fixed_left_sidebar_scroll = h,
          C.notifications_scroll = g,
          C.top_messages_scroll = f,
          C.announcement_scroll = m,
          C.chat_scroll = b,
          C.faqs_scroll = v,
          C.ticket_scroll = y,
          C.messages_scroll = w,
          ...
          $(".am-close").on("click", function() {
              var t = "";
              $(this).parents(".card").length ? t = $(this).parents(".card") : $(this).parents(".widget").length && (t = $(this).parents(".widget")),
...
function FastClick(t, e) {
  ...
  !FastClick.notNeeded(t)) {
      for (var r = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], n = 0, o = r.length; n < o; n++)
          this[r[n]] = a(this[r[n]], this);
...
FastClick.prototype.sendClick = function(t, e) {
  ...
  (n = document.createEvent("MouseEvents")).initMouseEvent("mousedown", !0, !0, window, 1, o.screenX, o.screenY, o.clientX, o.clientY, !1, !1, !1, !1, 0, null),
  n.forwardedTouchEvent = !0,
  t.dispatchEvent(n),
  (r = document.createEvent("MouseEvents")).initMouseEvent("mouseup", !0, !0, window, 1, o.screenX, o.screenY, o.clientX, o.clientY, !1, !1, !1, !1, 0, null),
  r.forwardedTouchEvent = !0,
  t.dispatchEvent(r),
  (i = document.createEvent("MouseEvents")).initMouseEvent(this.determineEventType(t), !0, !0, window, 1, o.screenX, o.screenY, o.clientX, o.clientY, !1, !1, !1, !1, 0, null),
...
FastClick.prototype.onTouchEnd = function(t) {
  ...
  "label" === (r = a.tagName.toLowerCase())) {
      ...
      return t.timeStamp - i > 100 || deviceIsIOS && window.top !== window && "input" === r ? (this.targetElement = null,
      !1) : (this.focus(a),
      this.sendClick(a, t),
      deviceIsIOS && "select" === r || (this.targetElement = null,
      t.preventDefault()),
      !1);
  return !(!deviceIsIOS || deviceIsIOS4 || !(n = a.fastClickScrollParent) || n.fastClickLastScrollTop === n.scrollTop) || (this.needsClick(a) || (t.preventDefault(),
  this.sendClick(a, t)),
  !1)
}
,
      ...
      this.each(function() {
          ...
          M || (M = new function(e, T) {
              function M(e) {
                  if (!(!0 === St.data(x + "_intouch") || t(e.target).closest(T.excludedElements, St).length > 0)) {
                      ...
                      if (!a.pointerType || "mouse" != a.pointerType || 0 != T.fallbackToMouseEvents) {
                          var l, s = a.touches, c = s ? s[0] : a;
                          return At = y,
                          s ? Ct = s.length : !1 !== T.preventDefaultEvents && e.preventDefault(),
                          pt = 0,
                          ht = null,
                          ft = null,
                          wt = null,
                          ...
                          q(),
                          K(0, c),
                          !s || Ct === T.fingers || T.fingers === b || O() ? (xt = ot(),
                          2 == Ct && (K(1, s[1]),
                          mt = bt = rt($t[0].start, $t[1].start)),
                          (T.swipeStatus || T.pinchStatus) && (l = P(a, At))) : l = !1,
                          !1 === l ? (P(a, At = S),
                          l) : (T.hold && (Dt = setTimeout(t.proxy(function() {
                              St.trigger("hold", [a.target]),
                              T.hold && (l = T.hold.call(St, a, a.target))
              ...
              function _(e) {
                  ...
                  if (At !== k && At !== S && !J()) {
                      var $, x = C.touches, M = x ? x[0] : C, _ = Z(M);
                      if (Tt = ot(),
                      x && (Ct = x.length),
                      T.hold && clearTimeout(Dt),
                      At = w,
                      2 == Ct && (0 == mt ? (K(1, x[1]),
                      mt = bt = rt($t[0].start, $t[1].start)) : (Z(x[1]),
                      bt = rt($t[0].end, $t[1].end),
                      $t[0].end,
                      $t[1].end,
                      wt = vt < 1 ? l : a),
                      vt = (bt / mt * 1).toFixed(2),
                      yt = Math.abs(mt - bt)),
                      Ct === T.fingers || T.fingers === b || !x || O()) {
                          if (ht = nt(_.start, _.end),
                          ft = nt(_.last, _.end),
                          function(t, e) {
                          ...
                          y = _.start,
                          A = _.end,
                          pt = Math.round(Math.sqrt(Math.pow(A.x - y.x, 2) + Math.pow(A.y - y.y, 2))),
                          gt = it(),
                          v = pt,
                          (f = ht) != s && (v = Math.max(v, tt(f)),
                          kt[f].distance = v),
                          $ = P(C, At),
                          !T.triggerOnTouchEnd || T.triggerOnTouchLeave) {
                              ...
                              !T.triggerOnTouchEnd && E ? At = R(w) : T.triggerOnTouchLeave && !E && (At = R(k)),
                              At != S && At != k || P(C, At)
                          }
                      } else
                          P(C, At = S);
              ...
              function E(t) {
                  var e, i = t.originalEvent ? t.originalEvent : t, r = i.touches;
                  if (r) {
                      if (r.length && !J())
                          return e = i,
                          Mt = ot(),
                          _t = e.touches.length + 1,
                          !0;
                      if (r.length && J())
                          return !0
                  }
                  ...
                  Tt = ot(),
                  gt = it(),
                  X() || !W() ? P(i, At = S) : T.triggerOnTouchEnd || !1 === T.triggerOnTouchEnd && At === w ? (!1 !== T.preventDefaultEvents && !1 !== t.cancelable && t.preventDefault(),
                  P(i, At = k)) : !T.triggerOnTouchEnd && U() ? F(i, At = k, p) : At === w && P(i, At = S),
                  Q(!1),
                  null
              }
              function L() {
              ...
              function R(t) {
                  var e = t
                    ...
                    , r = W()
                    , n = X();
                  return !i || n ? e = S : !r || t != w || T.triggerOnTouchEnd && !T.triggerOnTouchLeave ? !r && t == k && T.triggerOnTouchLeave && (e = S) : e = k,
                  e
              }
              function P(t, e) {
                  var i, r = t.touches;
                  return (!(!N() || !B()) || B()) && (i = F(t, e, d)),
                  (!(!I() || !O()) || O()) && !1 !== i && (i = F(t, e, u)),
                  G() && V() && !1 !== i ? i = F(t, e, h) : gt > T.longTapThreshold && pt < v && T.longTap && !1 !== i ? i = F(t, e, f) : !(1 !== Ct && A || !(isNaN(pt) || pt < T.threshold) || !U()) && !1 !== i && (i = F(t, e, p)),
                  e === S && L(),
                  e === k && (r && r.length || L()),
                  i
              }
              function F(e, s, c) {
                  var g;
                  if (c == d) {
                      if (St.trigger("swipeStatus", [s, ht || null, pt || 0, gt || 0, Ct, $t, ft]),
                      T.swipeStatus && !1 === (g = T.swipeStatus.call(St, e, s, ht || null, pt || 0, gt || 0, Ct, $t, ft)))
                          return !1;
                      if (s == k && N()) {
                          if (clearTimeout(Lt),
                          clearTimeout(Dt),
                          St.trigger("swipe", [ht, pt, gt, Ct, $t, ft]),
                          T.swipe && !1 === (g = T.swipe.call(St, e, ht, pt, gt, Ct, $t, ft)))
                              return !1;
                          switch (ht) {
                          case i:
                              St.trigger("swipeLeft", [ht, pt, gt, Ct, $t, ft]),
                              T.swipeLeft && (g = T.swipeLeft.call(St, e, ht, pt, gt, Ct, $t, ft));
                              break;
                          case r:
                              St.trigger("swipeRight", [ht, pt, gt, Ct, $t, ft]),
                              T.swipeRight && (g = T.swipeRight.call(St, e, ht, pt, gt, Ct, $t, ft));
                              break;
                          case n:
                              St.trigger("swipeUp", [ht, pt, gt, Ct, $t, ft]),
                              T.swipeUp && (g = T.swipeUp.call(St, e, ht, pt, gt, Ct, $t, ft));
                              break;
                          case o:
                              St.trigger("swipeDown", [ht, pt, gt, Ct, $t, ft]),
                              T.swipeDown && (g = T.swipeDown.call(St, e, ht, pt, gt, Ct, $t, ft))
                          }
                      }
                  }
                  if (c == u) {
                      if (St.trigger("pinchStatus", [s, wt || null, yt || 0, gt || 0, Ct, vt, $t]),
                      T.pinchStatus && !1 === (g = T.pinchStatus.call(St, e, s, wt || null, yt || 0, gt || 0, Ct, vt, $t)))
                          return !1;
                      if (s == k && I())
                          switch (wt) {
                          case a:
                              St.trigger("pinchIn", [wt || null, yt || 0, gt || 0, Ct, vt, $t]),
                              T.pinchIn && (g = T.pinchIn.call(St, e, wt || null, yt || 0, gt || 0, Ct, vt, $t));
                              break;
                          case l:
                              St.trigger("pinchOut", [wt || null, yt || 0, gt || 0, Ct, vt, $t]),
                              T.pinchOut && (g = T.pinchOut.call(St, e, wt || null, yt || 0, gt || 0, Ct, vt, $t))
                          }
                  }
                  return c == p ? s !== S && s !== k || (clearTimeout(Lt),
                  clearTimeout(Dt),
                  V() && !G() ? (Et = ot(),
                  Lt = setTimeout(t.proxy(function() {
                      Et = null,
                      St.trigger("tap", [e.target]),
                      T.tap && (g = T.tap.call(St, e, e.target))
                  }, this), T.doubleTapThreshold)) : (Et = null,
                  St.trigger("tap", [e.target]),
                  T.tap && (g = T.tap.call(St, e, e.target)))) : c == h ? s !== S && s !== k || (clearTimeout(Lt),
                  clearTimeout(Dt),
                  Et = null,
                  St.trigger("doubletap", [e.target]),
                  T.doubleTap && (g = T.doubleTap.call(St, e, e.target))) : c == f && (s !== S && s !== k || (clearTimeout(Lt),
                  Et = null,
                  St.trigger("longtap", [e.target]),
                  T.longTap && (g = T.longTap.call(St, e, e.target)))),
                  g
              }
              function W() {
                  var t = !0;
                  return null !== T.threshold && (t = pt >= T.threshold),
                  t
              }
              function X() {
                  var t = !1;
                  return null !== T.cancelThreshold && null !== ht && (t = tt(ht) - pt >= T.cancelThreshold),
                  t
              }
              function H() {
              ...
              function Q(t) {
                  St && (!0 === t ? (St.bind(st, _),
                  St.bind(ct, E),
                  dt && St.bind(dt, D)) : (St.unbind(st, _, !1),
                  St.unbind(ct, E, !1),
                  dt && St.unbind(dt, D, !1)),
                  St.data(x + "_intouch", !0 === t))
              }
              function K(t, e) {
                  var i = {
                      start: {
...
function(t, e) {
  ...
  function c(t, e, i, r, n) {
      ...
      var f, g, m = t.element;
      t.reach[u] = null,
      m[d] < 1 && (t.reach[u] = "start"),
      m[d] > t[o] - t[c] - 1 && (t.reach[u] = "end"),
      e && (m.dispatchEvent(s("ps-scroll-" + u)),
      e < 0 ? m.dispatchEvent(s("ps-scroll-" + p)) : e > 0 && m.dispatchEvent(s("ps-scroll-" + h)),
      r && (a(f = t, g = u),
      l(f, g))),
      t.reach[u] && (e || n) && m.dispatchEvent(s("ps-" + u + "-reach-" + t.reach[u]))
  }
  function d(t) {
  ...
  function p(t, e) {
      ...
      function r() {
          l(t, h),
          t[g].classList.remove(f.state.clicking),
      ...
      t.event.bind(t[d], "mousedown", function(e) {
          ...
          t[g].classList.add(f.state.clicking),
          e.stopPropagation(),
          e.preventDefault()
      })
  }
  ...
  var y = function(t, e, i, r, n) {
    ...
    , k = function(t) {
      ...
      i.contains(t.scrollbarXRail) || (o(i, f.element.rail("x")).forEach(function(t) {
          return n(t)
      }),
      i.appendChild(t.scrollbarXRail)),
      i.contains(t.scrollbarYRail) || (o(i, f.element.rail("y")).forEach(function(t) {
          return n(t)
      }),
      ...
      t.scrollbarXWidth = u(t, d(t.railXWidth * t.containerWidth / t.contentWidth)),
      t.scrollbarXLeft = d((t.negativeScrollAdjustment + i.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1,
      ...
      t.scrollbarYHeight = u(t, d(t.railYHeight * t.containerHeight / t.contentHeight)),
      t.scrollbarYTop = d(r * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1,
      ...
      function(t, i) {
          ...
          i.isScrollbarXUsingBottom ? r.bottom = i.scrollbarXBottom - n : r.top = i.scrollbarXTop + n,
      ...
      t.scrollbarXActive ? i.classList.add(f.state.active("x")) : (i.classList.remove(f.state.active("x")),
      t.scrollbarXWidth = 0,
      t.scrollbarXLeft = 0,
      i.scrollLeft = 0),
      t.scrollbarYActive ? i.classList.add(f.state.active("y")) : (i.classList.remove(f.state.active("y")),
    ...
    , S = {
      ...
      "drag-thumb": function(t) {
          p(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]),
          p(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"])
      },
      keyboard: function(t) {
          var e = t.element;
          t.event.bind(t.ownerDocument, "keydown", function(i) {
              if (!(i.isDefaultPrevented && i.isDefaultPrevented() || i.defaultPrevented) && (r(e, ":hover") || r(t.scrollbarX, ":focus") || r(t.scrollbarY, ":focus"))) {
                  ...
                  if (n) {
                      ...
                      if (r(l = n, "input,[contenteditable]") || r(l, "select,[contenteditable]") || r(l, "textarea,[contenteditable]") || r(l, "button,[contenteditable]"))
                          return
                  }
                  var o = 0
                    , a = 0;
      ...
      wheel: function(e) {
          function i(i) {
              var n, o, a, l, s, c, d, u, p, h, g = (o = (n = i).deltaX,
              a = -1 * n.deltaY,
              void 0 !== o && void 0 !== a || (o = -1 * n.wheelDeltaX / 6,
              a = n.wheelDeltaY / 6),
              n.deltaMode && 1 === n.deltaMode && (o *= 10,
              a *= 10),
              o != o && a != a && (o = 0,
              a = n.wheelDelta),
              n.shiftKey ? [-a, -o] : [o, a]), m = g[0], b = g[1];
              if (!function(e, i, n) {
                  ...
                  if (!r.contains(e))
                      return !1;
                  for (var o = e; o && o !== r; ) {
                      if (o.classList.contains(f.element.consuming))
                          return !0;
                      var a = t(o);
                  ...
                  var v = !1;
                  e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (b ? r.scrollTop -= b * e.settings.wheelSpeed : r.scrollTop += m * e.settings.wheelSpeed,
                  v = !0) : e.scrollbarXActive && !e.scrollbarYActive && (m ? r.scrollLeft += m * e.settings.wheelSpeed : r.scrollLeft -= b * e.settings.wheelSpeed,
                  v = !0) : (r.scrollTop -= b * e.settings.wheelSpeed,
                  r.scrollLeft += m * e.settings.wheelSpeed),
                  k(e),
                  (v = v || (l = m,
                  s = b,
                  c = Math.floor(r.scrollTop),
                  d = 0 === r.scrollTop,
                  u = c + r.offsetHeight === r.scrollHeight,
                  p = 0 === r.scrollLeft,
                  h = r.scrollLeft + r.offsetWidth === r.scrollWidth,
                  !(Math.abs(s) > Math.abs(l) ? d || u : p || h) || !e.settings.wheelPropagation)) && !i.ctrlKey && (i.stopPropagation(),
                  i.preventDefault())
              }
          }
          var r = e.element;
      ...
      touch: function(e) {
          ...
          function a(o) {
              if (n(o)) {
                  ...
                  function(t, i) {
                      ...
                      } else if (o > a && (t < 0 && n === e.contentWidth - e.containerWidth || t > 0 && 0 === n))
                          return !0;
                      return !0
          ...
          function l() {
              ...
              p = setInterval(function() {
                  e.isInitialized ? clearInterval(p) : u.x || u.y ? Math.abs(u.x) < .01 && Math.abs(u.y) < .01 ? clearInterval(p) : (i(30 * u.x, 30 * u.y),
                  u.x *= .8,
                  u.y *= .8) : clearInterval(p)
              }, 10))
          }
          if (w.supportsTouch || w.supportsIePointer) {
              var s = e.element
                ...
                , u = {}
                , p = null;
              w.supportsTouch ? (e.event.bind(s, "touchstart", o),
              e.event.bind(s, "touchmove", a),
              e.event.bind(s, "touchend", l)) : w.supportsIePointer && (window.PointerEvent ? (e.event.bind(s, "pointerdown", o),
              e.event.bind(s, "pointermove", a),
              e.event.bind(s, "pointerup", l)) : window.MSPointerEvent && (e.event.bind(s, "MSPointerDown", o),
              e.event.bind(s, "MSPointerMove", a),
              e.event.bind(s, "MSPointerUp", l)))
          }
      }
  }
    , A = function(r, n) {
      ...
      this.isNegativeScroll = (s = r.scrollLeft,
      r.scrollLeft = -1,
      l = r.scrollLeft < 0,
      r.scrollLeft = s,
      l),
      ...
      this.scrollbarXRail = i(f.element.rail("x")),
      r.appendChild(this.scrollbarXRail),
      this.scrollbarX = i(f.element.thumb("x")),
      ...
      this.scrollbarXTop = d(p.top)) : this.isScrollbarXUsingBottom = !0,
      this.railBorderXWidth = d(p.borderLeftWidth) + d(p.borderRightWidth),
      e(this.scrollbarXRail, {
          display: "block"
      }),
      this.railXMarginWidth = d(p.marginLeft) + d(p.marginRight),
      e(this.scrollbarXRail, {
          display: ""
      }),
      this.railXWidth = null,
      this.railXRatio = null,
      this.scrollbarYRail = i(f.element.rail("y")),
      r.appendChild(this.scrollbarYRail),
      this.scrollbarY = i(f.element.thumb("y")),
      ...
      this.scrollbarYLeft = d(m.left)) : this.isScrollbarYUsingRight = !0,
      this.scrollbarYOuterWidth = this.isRtl ? (h = this.scrollbarY,
      d((g = t(h)).width) + d(g.paddingLeft) + d(g.paddingRight) + d(g.borderLeftWidth) + d(g.borderRightWidth)) : null,
      this.railBorderYWidth = d(m.borderTopWidth) + d(m.borderBottomWidth),
      e(this.scrollbarYRail, {
          display: "block"
      }),
      this.railYMarginHeight = d(m.marginTop) + d(m.marginBottom),
      e(this.scrollbarYRail, {
          display: ""
      }),
  ...
  return A.prototype.update = function() {
      ...
      this.railXMarginWidth = d(t(this.scrollbarXRail).marginLeft) + d(t(this.scrollbarXRail).marginRight),
      this.railYMarginHeight = d(t(this.scrollbarYRail).marginTop) + d(t(this.scrollbarYRail).marginBottom),
      e(this.scrollbarXRail, {
          display: "none"
      }),
      e(this.scrollbarYRail, {
...
function(t) {
  function e(i, r) {
      ...
      d = !1,
      u = !1,
      "string" == typeof (n = i) && (n = function(t) {
      ...
      d = !0,
      u = "%" === String(n.r).substr(-1) ? "prgb" : "rgb") : T(n.h) && T(n.s) && T(n.v) ? (l = C(n.s),
      s = C(n.v),
      o = function(e, i, r) {
          e = 6 * w(e, 360),
          i = w(i, 100),
      ...
      d = !0,
      u = "hsv") : T(n.h) && T(n.s) && T(n.l) && (l = C(n.s),
      c = C(n.l),
      o = function(t, e, i) {
          function r(t, e, i) {
              return 0 > i && (i += 1),
      ...
      this._format = r.format || g.format,
  ...
  function i(t, e, i) {
      ...
      e = w(e, 255),
      i = w(i, 255);
      var r, n, o = Y(t, e, i), a = D(t, e, i), l = (o + a) / 2;
      if (o == a)
          r = n = 0;
      else {
          var s = o - a;
          switch (n = l > .5 ? s / (2 - o - a) : s / (o + a),
          o) {
          case t:
              r = (e - i) / s + (i > e ? 6 : 0);
              break;
  ...
  function r(t, e, i) {
      ...
      e = w(e, 255),
      i = w(i, 255);
      var r, n, o = Y(t, e, i), a = D(t, e, i), l = o, s = o - a;
      if (n = 0 === o ? 0 : s / o,
      o == a)
          r = 0;
      else {
  ...
  function d(t, i) {
      i = 0 === i ? 0 : i || 10;
      var r = e(t).toRgb();
      return r.r = Y(0, D(255, r.r - L(-i / 100 * 255))),
      r.g = Y(0, D(255, r.g - L(-i / 100 * 255))),
      r.b = Y(0, D(255, r.b - L(-i / 100 * 255))),
      e(r)
  }
  function u(t, i) {
      i = 0 === i ? 0 : i || 10;
  ...
  function v(t, i) {
      i = i || 6;
      for (var r = e(t).toHsv(), n = r.h, o = r.s, a = r.v, l = [], s = 1 / i; i--; )
          l.push(e({
              h: n,
              s: o,
              v: a
  ...
  function w(e, i) {
      ...
      return e = D(i, Y(0, parseFloat(e))),
      o && (e = parseInt(e * i, 10) / 100),
      t.abs(e - i) < 1e-6 ? 1 : e % i / parseFloat(i)
  }
  function k(t) {
      return D(1, Y(0, t))
  }
  ...
  e.prototype = {
      ...
      getLuminance: function() {
          ...
          i = n.g / 255,
          r = n.b / 255,
          .2126 * (.03928 >= e ? e / 12.92 : t.pow((e + .055) / 1.055, 2.4)) + .7152 * (.03928 >= i ? i / 12.92 : t.pow((i + .055) / 1.055, 2.4)) + .0722 * (.03928 >= r ? r / 12.92 : t.pow((r + .055) / 1.055, 2.4))
      },
      setAlpha: function(t) {
          return this._a = y(t),
          this._roundA = L(100 * this._a) / 100,
      ...
      toHex8: function(t) {
          ...
          n = this._a,
          o = t,
          a = [A(L(e).toString(16)), A(L(i).toString(16)), A(L(r).toString(16)), A($(n))],
          o && a[0].charAt(0) == a[0].charAt(1) && a[1].charAt(0) == a[1].charAt(1) && a[2].charAt(0) == a[2].charAt(1) && a[3].charAt(0) == a[3].charAt(1) ? a[0].charAt(0) + a[1].charAt(0) + a[2].charAt(0) + a[3].charAt(0) : a.join("");
          var e, i, r, n, o, a
      },
      ...
      toString: function(t) {
          ...
          return !e && r && ("hex" === t || "hex6" === t || "hex3" === t || "hex4" === t || "hex8" === t || "name" === t) ? "name" === t && 0 === this._a ? this.toName() : this.toRgbString() : ("rgb" === t && (i = this.toRgbString()),
  ...
  e.fromRatio = function(t, i) {
      if ("object" == typeof t) {
          var r = {};
          for (var n in t)
              t.hasOwnProperty(n) && (r[n] = "a" === n ? t[n] : C(t[n]));
          t = r
      }
      return e(t, i)
  }
  ...
  e.isReadable = function(t, i, r) {
      ...
      "small" !== (s = (a.size || "small").toLowerCase()) && "large" !== s && (s = "small"),
      (n = {
          level: l,
          size: s
      }).level + n.size) {
  ...
  e.mostReadable = function(t, i, r) {
      var n, o, a, l, s = null, c = 0;
      o = (r = r || {}).includeFallbackColors,
      a = r.level,
      l = r.size;
      for (var d = 0; d < i.length; d++)
          (n = e.readability(t, i[d])) > c && (c = n,
          s = e(i[d]));
      return e.isReadable(t, s, {
          level: a,
          size: l
      }) || !o ? s : (r.includeFallbackColors = !1,
      e.mostReadable(t, ["#fff", "#000"], r))
  }
  ;
  var P, F, W, X = e.names = {
      aliceblue: "f0f8ff",
...
App = function() {
  ...
  return App.ChartJs = function() {
      ...
      e = tinycolor(App.color.primary).lighten(22),
      ...
      n = tinycolor(App.color.primary),
      o = tinycolor(App.color.primary).lighten(22),
      a = document.getElementById("bar-chart"),
      l = {
          labels: ["January", "February", "March", "April", "May", "June", "July"],
          datasets: [{
              label: "Credit",
      ...
      s = tinycolor(App.color.primary).lighten(20),
      c = tinycolor(App.color.primary),
      ...
      p = App.color.primary,
      h = tinycolor(App.color.primary).lighten(7).toString(),
      f = tinycolor(App.color.primary).lighten(14).toString(),
      g = tinycolor(App.color.primary).lighten(21).toString(),
      m = tinycolor(App.color.primary).lighten(28).toString(),
      ...
      v = App.color.primary,
      y = tinycolor(App.color.primary).lighten(12).toString(),
      w = tinycolor(App.color.primary).lighten(22).toString(),
      k = document.getElementById("pie-chart"),
      new Chart(k,{
          type: "pie",
          data: {
      ...
      S = App.color.primary,
      A = tinycolor(App.color.primary).lighten(12).toString(),
      C = tinycolor(App.color.primary).lighten(22).toString(),
...
App = function() {
  ...
  return App.chartsMorris = function() {
      ...
      t = App.color.primary,
      e = tinycolor(App.color.primary).lighten(15).toString(),
      new Morris.Line({
          element: "line-chart",
          data: u,
          xkey: "period",
      ...
      i = tinycolor(App.color.alt3).lighten(15).toString(),
      r = tinycolor(App.color.alt3).brighten(3).toString(),
      Morris.Bar({
          element: "bar-chart",
          data: [{
              device: "iPhone",
...
App = function() {
  ...
  return App.chartsSparklines = function() {
      var t = tinycolor(App.color.primary)
        ...
        , a = i.toString()
        , l = r.toString();
      $.fn.sparkline.defaults.common.lineColor = n,
      $.fn.sparkline.defaults.common.fillColor = t.setAlpha(.3).toString(),
      $.fn.sparkline.defaults.line.spotColor = n,
      $.fn.sparkline.defaults.line.minSpotColor = n,
      $.fn.sparkline.defaults.line.maxSpotColor = n,
      $.fn.sparkline.defaults.line.highlightSpotColor = n,
      $.fn.sparkline.defaults.line.highlightLineColor = n,
      $.fn.sparkline.defaults.bar.barColor = n,
      $.fn.sparkline.defaults.bar.negBarColor = o,
      $.fn.sparkline.defaults.bar.stackedBarColor[0] = n,
      $.fn.sparkline.defaults.bar.stackedBarColor[1] = o,
      $.fn.sparkline.defaults.tristate.posBarColor = n,
      $.fn.sparkline.defaults.tristate.negBarColor = o,
      $.fn.sparkline.defaults.discrete.thresholdColor = o,
      $.fn.sparkline.defaults.bullet.targetColor = n,
      $.fn.sparkline.defaults.bullet.performanceColor = o,
      $.fn.sparkline.defaults.bullet.rangeColors[0] = e.setAlpha(.2).toString(),
      $.fn.sparkline.defaults.bullet.rangeColors[1] = e.setAlpha(.5).toString(),
      $.fn.sparkline.defaults.bullet.rangeColors[2] = e.setAlpha(.45).toString(),
      $.fn.sparkline.defaults.pie.sliceColors[0] = n,
      $.fn.sparkline.defaults.pie.sliceColors[1] = o,
      $.fn.sparkline.defaults.pie.sliceColors[2] = a,
      $.fn.sparkline.defaults.box.medianColor = n,
      $.fn.sparkline.defaults.box.boxFillColor = e.setAlpha(.5).toString(),
      $.fn.sparkline.defaults.box.boxLineColor = n,
      $.fn.sparkline.defaults.box.whiskerColor = l,
  ...
  return App.charts = function() {
      ...
      $('[data-toggle="counter"]').each(function(t, e) {
          var i = $(this)
            ...
            , l = 0
            , s = 2.5;
          i.data("prefix") && (r = i.data("prefix")),
          i.data("suffix") && (n = i.data("suffix")),
          i.data("start") && (o = i.data("start")),
          i.data("end") && (a = i.data("end")),
          i.data("decimals") && (l = i.data("decimals")),
          i.data("duration") && (s = i.data("duration")),
          new CountUp(i.get(0),o,a,l,s,{
              suffix: n,
              prefix: r
          }).start()
      }),
      ...
      i = tinycolor(App.color.primary).brighten(9).toString(),
      r = tinycolor(App.color.primary).lighten(13).toString(),
      n = tinycolor(App.color.primary).lighten(20).toString(),
      o = tinycolor(App.color.primary).lighten(27).toString(),
      $.plot("#pie-chart4", [{
          label: "Google",
          data: 45
      }, {
      ...
      a = tinycolor(App.color.alt3).lighten(15).toString(),
      l = tinycolor(App.color.alt3).brighten(3).toString(),
      $.plot($("#bar-chart1"), [{
      ...
      c = App.color.alt2,
      d = App.color.alt1,
      u = $("#widget-top-1").parent().next().find(".legend"),
      $.plot("#widget-top-1", [{
      ...
      p = tinycolor(App.color.alt1).lighten(7).toString(),
      h = App.color.alt1,
      $.plot("#linechart-mini1", [{
          data: [[1, 20], [2, 60], [3, 35], [4, 70], [5, 45]],
          canvasRender: !0
      }, {
          data: [[1, 60], [2, 20], [3, 65], [4, 35], [5, 65]],
          canvasRender: !0
      }], {
          series: {
              lines: {
      ...
      g = App.color.primary,
      m = [[1, t()], [2, t()], [3, 2 + t()], [4, 3 + t()], [5, 5 + t()], [6, 10 + t()], [7, 15 + t()], [8, 20 + t()], [9, 25 + t()], [10, 30 + t()], [11, 35 + t()], [12, 25 + t()], [13, 15 + t()], [14, 20 + t()], [15, 45 + t()], [16, 50 + t()], [17, 65 + t()], [18, 70 + t()], [19, 85 + t()], [20, 80 + t()], [21, 75 + t()], [22, 80 + t()], [23, 75 + t()]],
      b = [[1, t()], [2, t()], [3, 10 + t()], [4, 15 + t()], [5, 20 + t()], [6, 25 + t()], [7, 30 + t()], [8, 35 + t()], [9, 40 + t()], [10, 45 + t()], [11, 50 + t()], [12, 55 + t()], [13, 60 + t()], [14, 70 + t()], [15, 75 + t()], [16, 80 + t()], [17, 85 + t()], [18, 90 + t()], [19, 95 + t()], [20, 100 + t()], [21, 110 + t()], [22, 120 + t()], [23, 130 + t()]],
      ...
      v = App.color.alt3,
      y = $("#line-chart2").parent().find(".counter .value").get(0),
      $.plot("#line-chart2", [{
      ...
      w = tinycolor(App.color.primary).lighten(5).toString(),
      $.plot($("#line-chart3"), [{
          data: [[0, 20], [1, 30], [2, 25], [3, 39], [4, 35], [5, 40], [6, 30], [7, 45]],
          label: "Page Views"
      }], {
      ...
      k = App.color.alt3,
      S = tinycolor(App.color.alt3).lighten(22).toString(),
      $.plot($("#bar-chart2"), [{
...
App = function() {
  ...
  return App.dashboard = function() {
      ...
      t = tinycolor(App.color.primary).lighten(5).toString(),
      e = App.color.alt2,
      i = App.color.alt1,
      r = $("#widget-top-1").parent().next().find(".legend"),
      $.plot("#widget-top-1", [{
          label: "Premium Purchases",
          data: 15
      }, {
      ...
      l = App.color.alt1,
      s = tinycolor(App.color.primary).lighten(5).toString(),
      c = $("#widget-top-2").parent().next().find(".legend"),
      $.plot("#widget-top-2", [{
          label: "Direct Access",
          data: 20
      }, {
      ...
      d = App.color.alt3,
      u = tinycolor(App.color.alt4).lighten(6.5).toString(),
      $.plot("#widget-top-3", [{
          label: "Google Ads",
          data: 70
      }, {
      ...
      var p, h, f, g, m, b, v, y, w, k = App.color.alt2, S = tinycolor(App.color.primary).lighten(5).toString();
      ...
      function() {
          ...
          var s = l[n.getMonth()]
            , c = n.getDate();
          r.html(s + " " + c),
          void 0 !== jQuery.ui && $(".ui-datepicker").datepicker({
      ...
      h = tinycolor(App.color.primary).lighten(23).toString(),
      f = tinycolor(App.color.primary).brighten(5).toString(),
      $.plot($("#barchart-mini1"), [{
          data: [[0, 15], [1, 15], [2, 19], [3, 28], [4, 30], [5, 37], [6, 35], [7, 38], [8, 48], [9, 43], [10, 38], [11, 32], [12, 38]],
          label: "Page Views"
      }, {
      ...
      m = tinycolor(App.color.primary).lighten(6),
      b = tinycolor(App.color.alt4).lighten(6.5),
      v = document.getElementById("radar-chart1"),
      y = {
          labels: ["January", "February", "March", "April", "May", "June", "July"],
          datasets: [{
              label: "Second Year",
...
App = function() {
  ...
  return App.dashboard2 = function() {
      ...
      e = [[1, t()], [2, t()], [3, 2 + t()], [4, 3 + t()], [5, 5 + t()], [6, 10 + t()], [7, 15 + t()], [8, 20 + t()], [9, 25 + t()], [10, 30 + t()], [11, 35 + t()], [12, 25 + t()], [13, 15 + t()], [14, 20 + t()], [15, 45 + t()], [16, 50 + t()], [17, 65 + t()], [18, 70 + t()], [19, 85 + t()], [20, 80 + t()], [21, 75 + t()], [22, 80 + t()], [23, 75 + t()]],
      i = [[1, t()], [2, t()], [3, 10 + t()], [4, 15 + t()], [5, 20 + t()], [6, 25 + t()], [7, 30 + t()], [8, 35 + t()], [9, 40 + t()], [10, 45 + t()], [11, 50 + t()], [12, 55 + t()], [13, 60 + t()], [14, 70 + t()], [15, 75 + t()], [16, 80 + t()], [17, 85 + t()], [18, 90 + t()], [19, 95 + t()], [20, 100 + t()], [21, 110 + t()], [22, 120 + t()], [23, 130 + t()]],
      r = tinycolor(App.color.primary).lighten(22),
      n = App.color.primary,
      $.plot($("#line-chart-live"), [{
          data: i,
          showLabels: !0,
      ...
      o = tinycolor(App.color.primary).lighten(5).toString(),
      $.plot($("#line-chart1"), [{
          data: [[0, 20], [1, 30], [2, 25], [3, 39], [4, 35], [5, 40], [6, 30], [7, 45]],
          label: "Page Views"
      }], {
      ...
      a = tinycolor(App.color.primary).brighten(9).toString(),
      l = tinycolor(App.color.primary).lighten(13).toString(),
      s = tinycolor(App.color.primary).lighten(20).toString(),
      c = tinycolor(App.color.primary).lighten(27).toString(),
      $.plot("#pie-chart4", [{
          label: "Google",
          data: 45
      }, {
      ...
      d = tinycolor(App.color.primary).lighten(23).toString(),
      u = tinycolor(App.color.primary).brighten(5).toString(),
      $.plot($("#bar-chart1"), [{
          data: [[0, 15], [1, 15], [2, 19], [3, 28], [4, 30], [5, 37], [6, 35], [7, 38], [8, 48], [9, 43], [10, 38], [11, 32], [12, 38]],
          label: "Page Views"
      }, {
      ...
      (h = new Skycons({
          color: "#555555"
      })).add($(".icon1", p)[0], Skycons.CLEAR_DAY),
      h.add($(".icon2", p)[0], Skycons.PARTLY_CLOUDY_DAY),
      h.add($(".icon3", p)[0], Skycons.RAIN),
      h.play()
  }
  ,
  App
...
App = function() {
  ...
  return App.pageCalendar = function() {
      ...
      var t, e, i = new Date, r = i.getDate(), n = i.getMonth(), o = i.getFullYear();
      ...
      (e = new Skycons({
          color: "#555555"
      })).add($(".icon1", t)[0], Skycons.CLEAR_DAY),
      e.add($(".icon2", t)[0], Skycons.PARTLY_CLOUDY_DAY),
      e.add($(".icon3", t)[0], Skycons.RAIN),
      e.play()
  }
  ,
  App
...
App = function() {
  ...
  return App.uiChat = function() {
      var t, e;
      t = App.scroller.initScroller($(".am-scroller-page-chat")),
      e = App.scroller.initScroller($(".am-scroller-page-messages")),
      $(window).resize(function() {
          waitForFinalEvent(function() {
              App.scroller.updateScroller(t),
              App.scroller.updateScroller(e)
          }, 500)
      })
  }
  ,
